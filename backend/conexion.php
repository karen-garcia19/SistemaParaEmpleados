...
function anadirempleados($id_empleado, $nombre, $apellido, $correo, $usuario, $id_departamento, $password, $conexion)
{
    $query = "INSERT INTO empleados (ID_empleado,ID_departamento,Nombre_empleado,Apellido_empleado,Correo,Usuario,pass,rol) 
    VALUES ($id_empleado,$id_departamento,'$nombre','$apellido','$correo','$usuario','$password',0)";
    if (mysqli_query($conexion, $query)) {
    } else {
        echo "Error: " . $query . "<br>" . mysqli_error($conexion);
    }
