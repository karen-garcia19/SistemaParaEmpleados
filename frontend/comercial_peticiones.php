...
if (isset($_POST['subir_archivos'])) {
  ...
  if (file_exists('archivos/' . $nombre)) {
    if (registrar_archivos_bd3($nombre, 'archivos/' . $nombre, $_DEPARTAMENTO, $conexion)) {
...
if (isset($_POST['aprobar'])) {
  if (actualizarStatus_bd3(1, $conexion, $_POST['ID_documento'])) {
...
if (isset($_POST['rechazar'])) {
  if (actualizarStatus_bd3(2, $conexion, $_POST['ID_documento'])) {
    echo "<script>alert('Estatus actualizado')</script>";
  } else {
    echo "<script>alert('Estatus no actualizado')</script>";
  }
...
$documentosPendientes = getDocumentosLegalesPendientes3($conexion);
$documentosAceptados = getDocumentosLegalesAprobados3($conexion);
$documentosRechazados = getDocumentosLegalesRechazados3($conexion);
?>
...
<head>
  ...
  <title>Comercial - Peticiones</title>
...
<body class="sb-nav-fixed">
  ...
  <div id="mySidebar" class="sidebar">
    ...
    <h1 style="color: white; font-size: 30px;">Comercial - Peticiones</h1>
  ...
  <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark mb-0">
    ...
    <!-- Navbar Brand-->
    <a class="navbar-brand ps-3" href="administracion_index.phh">Comercial - Peticiones</a>
    <!-- Navbar Search-->
  ...
  <div class="row">
    <div class="col-md-12 contenedorInferior">
      <form action="comercial_peticiones.php" method="POST" enctype="multipart/form-data">
        <h1 class="titulosAdmin">Subir peticiones de comercial</h1>
        <center>
          <h1> </h1>
          <div class="">
            ...
            <div class="col-md-12">
              <div id="Carousel" class="carousel slide">
                <ol class="carousel-indicators">
                  <?php
                  for ($slide = 0; $slide < getNumSlidesFromDocuments2(mysqli_num_rows($documentosPendientes)); $slide++) {
                  ?>
                ...
                <div class="carousel-inner">
                  <?php
                  $currentIndex = array();
                  for ($slide = 0; $slide < getNumSlidesFromDocuments3(mysqli_num_rows($documentosPendientes)); $slide++) {
                    $stepCounter = 0;
                  ?>
                      ...
                      <div class="row">
                        ...
                        ?>
                            <div class="col-md-4">
                              ...
                              &nbsp;&nbsp;&emsp;<form action="comercial_peticiones.php" method="POST">
          ...
          <div class="row">
            <div class="col-md-12">
              <div id="Carousel2" class="carousel slide">
                <ol class="carousel-indicators">
                  <?php
                  for ($slide2 = 0; $slide2 < getNumSlidesFromDocuments3(mysqli_num_rows($documentosAceptados)); $slide2++) {
                  ?>
          ...
          <div class="row">
            <div class="col-md-12">
              <div id="Carousel3" class="carousel slide">
                <ol class="carousel-indicators">
                  <?php
                  for ($slide3 = 0; $slide3 < getNumSlidesFromDocuments3(mysqli_num_rows($documentosRechazados)); $slide3++) {
                  ?>
                      ...
                      <div class="row">
                        ...
                        ?>
                            <div class="col-md-4">
                              ...
                              &nbsp;&nbsp;&emsp;<form action="comercial_peticiones" method="POST">
