...
if (isset($_POST['subir_archivos'])) {
  ...
  if (file_exists('archivos/' . $nombre)) {
    if (registrar_archivos_bd2($nombre, 'archivos/' . $nombre, $_DEPARTAMENTO, $conexion)) {
...
if (isset($_POST['aprobar'])) {
  if (actualizarStatus_bd2(1, $conexion, $_POST['ID_documento'])) {
...
if (isset($_POST['rechazar'])) {
  if (actualizarStatus_bd2(2, $conexion, $_POST['ID_documento'])) {
    echo "<script>alert('Estatus actualizado')</script>";
  } else {
    echo "<script>alert('Estatus no actualizado')</script>";
  }
...
$documentosPendientes = getDocumentosLegalesPendientes2($conexion);
$documentosAceptados = getDocumentosLegalesAprobados2($conexion);
$documentosRechazados = getDocumentosLegalesRechazados2($conexion);
?>
...
<head>
  ...
  <title>Administracion - Aprobación</title>
...
<body class="sb-nav-fixed">
  ...
  <div id="mySidebar" class="sidebar">
    ...
    <h1 style="color: white; font-size: 30px;">Administracion - Aprobacion</h1>
  ...
  <div class="row">
    <div class="col-md-12 contenedorInferior">
      <form action="administracion_aprobacion.php" method="POST" enctype="multipart/form-data">
        <h1 class="titulosAdmin">Subir peticiones de administración</h1>
        <center>
          <h1> </h1>
          <div class="">
                      ...
                      <div class="row">
                        ...
                        ?>
                            <div class="col-md-4">
                              ...
                              &nbsp;&nbsp;&emsp;<form action="administracion_aprobacion.php" method="POST">
          ...
          <div class="row">
            <div class="col-md-12">
              <div id="Carousel3" class="carousel slide">
                <ol class="carousel-indicators">
                  <?php
                  for ($slide3 = 0; $slide3 < getNumSlidesFromDocuments2(mysqli_num_rows($documentosRechazados)); $slide3++) {
                  ?>
